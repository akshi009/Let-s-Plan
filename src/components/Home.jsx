...
function Home() {
      ...
      <div className="bg-gradient-to-r from-blue-900 to-indigo-900 h-screen flex items-center justify-center text-white">
        <div className="bg-slate-800 p-8 rounded-lg shadow-xl text-center">
          ...
          <div className="flex gap-4 justify-center">
            <button className="bg-blue-600 hover:bg-blue-700 px-6 py-2 rounded-md transition-colors">
              Login
            </button>
            <button className="bg-indigo-600 hover:bg-indigo-700 px-6 py-2 rounded-md transition-colors">
              Sign Up
            </button>
          </div>
        </div>
  ...
  return (
    <div className="flex h-screen bg-gray-200">
      ...
      <div className="md:flex-1 md:p-6 overflow-auto p-4">
        {selectedTodo ? (
